			...
			<div class="step step1">
				...
				<table>
					...
					<s:iterator var="orderItem" value="model.orderItems">
						<tr>
							<td width="60">
								<input type="hidden" name="pid" value="<s:property value="#orderItem.product.pid"/>"/>
							...
							<td>
								<a href="${ pageContext.request.contextPath }/cart_removeCart.action?pid=<s:property value="#orderItem.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
