					...
					<form id="loginForm" action="${ pageContext.request.contextPath }/user_login.action"  method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20" value="<%=username %>">
							...
							<tr>
								...
								<td>
									<label>
										<input type="checkbox" id="isRememberUsername" name="isRememberUsername" value="isRememberUsername" <%=check %>>记住用户名
									</label>
									<label>
										&nbsp;&nbsp;<a >找回密码</a>
									</label>
