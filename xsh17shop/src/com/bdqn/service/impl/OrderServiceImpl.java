...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public PageBean<Order> findByPageWithState(Integer page, Integer state) {
		PageBean<Order> pageBean = new PageBean<>();
		//设置页数
		pageBean.setPage(page);
		int limit = 10;
		...
		int totalCount = orderDao.findByState(state);
		pageBean.setTotalCount(totalCount);
		...
		int begin = (page -1)*limit;
		List<Order> list = orderDao.findByPageWithState(begin, limit, state);
		pageBean.setList(list);
